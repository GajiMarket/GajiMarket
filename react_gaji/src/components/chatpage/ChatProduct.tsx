  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        const response = await axios.get(import.meta.env.MODE === 'production' ?`https://gajimarket-api-dot-winged-woods-442503-f1.du.r.appspot.com/api/product/${productId}` : `${api}/api/product/${productId}`);

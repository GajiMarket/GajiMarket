...
const Password: React.FC<PasswordProps> = ({password, passwordCheck, onChange1, onChange2, errors, checkErrors}) => {
  return (
    <div className="pw">
       ...
       {checkErrors && <span className="errorMessage">{checkErrors}</span>}
    </div>

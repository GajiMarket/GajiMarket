...
export const signUpDAO = async (formData: Record<string, string>, password: string): Promise<boolean | void> => {
...
// 카카오는 1번
export const saveOrUpdateUser = async (formData: Record<string, string>, password: string): Promise<loginType> => {
